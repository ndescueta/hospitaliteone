  ...
  <div class="container-fluid">
    <div class="row page-titles">
      <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Hospital Director</h4>
      </div>
    </div>
    <!-- //////////////////////////////Content -->
    <div class="card">
      <div class="row">
        <div class="col-lg-12">
          <div class="card-body">
            <h4 class="card-title m-t-10">Directors of the Hospital</h4>
            <div class="row">
              <div class="col-md-12">
                <!-- directors table -->
                <div id="directors">
                  ...
                  $fetch_directors = mysqli_query($connections, "SELECT intDirectorId, strDirectorFirstName, strDirectorMiddleName, strDirectorLastName, strDirectorContact FROM tbldirector ");
                ...
                <!-- Add Directors -->
                <a href="#" data-toggle="modal" data-target="#add-new-director" class="btn m-t-10 btn-info btn-block waves-effect waves-light">
                  <i class="ti-plus"></i> Add New Director
                </a>
              </div>
            </div>
          </div>
...
<!-- modal declarations -->
<!-- add Director -->
<div id="add-new-director" name="add-new-director" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="addnewdirectorlabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Add New Hospital Director</h4>
...
<!-- edit director -->
<div id="modal_editDirector" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="editdirectorlabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <form class="form-material" method="post" name="editDirector">
        <div class="modal-body">
          ...
          <div class="row">
            <input type="hidden" name="hidden_directorid" id="hidden_directorid">
          
            <div class="form-group col-md-12">
              <label for="directorFirstName">First Name</label>
              <input type="text" class="form-control" name="edit_directorFirstName" id="edit_directorFirstName">
            </div>

            <div class="form-group col-md-12">
              <label for="directorMiddleName">Middle Name</label>
              <input type="text" class="form-control" name="edit_directorMiddleName" id="edit_directorMiddleName">
            </div>

            <div class="form-group col-md-12">
              <label for="directorLastName">Last Name</label>
              <input type="text" class="form-control" name="edit_directorLastName" id="edit_directorLastName">
            </div>

            <div class="form-group col-md-12">
              <label for="directorContact">Contact Number</label>
              <input type="text" class="form-control" name="edit_directorContact" id="edit_directorContact">
            </div>
